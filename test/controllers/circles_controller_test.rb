...
class CirclesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create circle" do
    assert_difference('Circle.count') do
      post circles_url, params: { circle: { cost: @circle.cost, intercollege: @circle.intercollege, name: @circle.name, profile: @circle.profile } }
    end
  ...
  test "should update circle" do
    patch circle_url(@circle), params: { circle: { cost: @circle.cost, intercollege: @circle.intercollege, name: @circle.name, profile: @circle.profile } }
